...
const Projects = () => {
  ...
  const projects = [
    {
      ...
      description: 'A comprehensive platform for community management and collaboration',
      image: '🌐',
    ...
    },
    {
      ...
      category: 'Full-Stack',
      description: 'Complete solution for organizing and managing community events',
      image: '🎪',
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'Research': return 'var(--secondary-color)'
